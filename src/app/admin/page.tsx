...
import { loginEventAction } from '@/features/competitions/actions/auth-event'
...
export default function AdminLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const result = await loginEventAction(password)
      if (result.ok) {
        router.push(`/admin/competiciones/${result.competition.slug}`)
      } else {
